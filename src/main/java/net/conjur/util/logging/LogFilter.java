 ...
 * holder.
 */
package net.conjur.util.logging;
...
public class LogFilter implements ContainerRequestFilter, ClientRequestFilter, ContainerResponseFilter,
        ClientResponseFilter, WriterInterceptor {

    private static final Log LOGGER = LogFactory.getLog(LogFilter.class.getName());
    private static final String NOTIFICATION_PREFIX = "* ";
    private static final String REQUEST_PREFIX = "> ";
    private static final String RESPONSE_PREFIX = "< ";
    private static final String ENTITY_LOGGER_PROPERTY = LogFilter.class.getName() + ".entityLogger";
    //
     ...
     */
    public LogFilter(Log logger, boolean printEntity, boolean printHeaders) {
        this.logger = logger;
     ...
     */
    public LogFilter(Log logger, int maxEntitySize, boolean printHeaders) {
        this.logger = logger;
    ...
    public LogFilter(Log logger, int maxEntitySize){
        this(logger, maxEntitySize, true);
    }
