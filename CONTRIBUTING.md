...
You will want to get in contact with the Infrastructure team via our [Slack](https://slackin-conjur.herokuapp.com/) to be granted access. If you have been granted access, run: `docker login registry2.itci.conjur.net` 
